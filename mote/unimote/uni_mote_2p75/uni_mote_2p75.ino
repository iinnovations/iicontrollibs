...
// TODO : add in that neat little modular piece that says : if NODEID==1, then act like a gateway
// and send stuff to serial instead of RF
// saves some time building in modularity
