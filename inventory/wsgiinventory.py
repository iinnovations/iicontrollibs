def application(environ, start_response):
    ...
    from iiutilities.utility import unmangleAPIdata, newunmangle
        ...
        try:
            ...
            # Panel builder
                ...
                if action == 'panelcalcsgenquote':
                    ...
                    datedquotefilename = 'panelbuilder_quote_' + datalib.gettimestring().replace(' ','_').replace(':','_') + '.pdf'
                    datedbomfilename = 'panelbuilder_bom_' + datalib.gettimestring().replace(' ','_').replace(':','_') + '.pdf'
                    ...
                    desscription = 'Control panel quote generated by panelbuilder.'
                    datedquotes = True
                    if datedquotes:

                        inventorylib.writequotetopdf(**{'bomdata': bomresults['bom'], 'options': bomresults['options'],
                            'title':'Quote auto-generated by panelbuilder   \t\t' +
                            datalib.gettimestring(), 'price': str(output['data']['bomcalcs']['totalprice']),
                        'outputfile': outputroot + datedquotefilename, 'description':desscription})

                    inventorylib.writequotetopdf(**{'bomdata': bomresults['bom'], 'options': bomresults['options'],
                            'title':'Quote auto-generated by panelbuilder '+ datalib.gettimestring(),
                           'price': output['data']['bomcalcs']['totalprice'], 'outputfile':outputroot + 'pbquote.pdf'})

                    if datedquotes:
                        inventorylib.writequotetopdf(**{'bomdata': bomresults['bom'], 'options': bomresults['options'],
                            'title':'Quote auto-generated by panelbuilder '
                          + datalib.gettimestring(), 'outputfile': outputroot + datedbomfilename})

                    inventorylib.writebomtopdf(**{'bomdata': bomresults['bom'], 'title': 'panelbuilder BOM generated '+ datalib.gettimestring(),
                                     'outputfile': outputroot + 'pbbom.pdf', 'totalprice': output['data']['bomcalcs']['totalprice']})
