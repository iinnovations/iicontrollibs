                            ...
                            if output['name'] == outputsetname:
                                if controllib.checkifenableready(output['name'], outputs):
                                    ...
                                    if output['status'] == 0:
                                        ...
                                        pilib.sqlitequery(pilib.controldatabase,
                                                          'update outputs set ontime=\'' + ontime + '\'' + 'where name=\'' +
                                                          output['name'] + '\'')
                                        pilib.sqlitequery(pilib.controldatabase,
                                                          'update outputs set status=1 ' + 'where name=\'' + output[
                                                              'name'] + '\'')
                                ...
                                if controllib.checkifdisableready(output['name'], outputs):
                                    ...
                                    if output['status'] == 1:
                                        ...
                                        pilib.sqlitequery(pilib.controldatabase,
                                                          'update outputs set offtime=\'' + offtime + '\'' + 'where name=\'' +
                                                          output['name'] + '\'')
                                        pilib.sqlitequery(pilib.controldatabase,
                                                          'update outputs set status=0 ' + 'where name=\'' + output[
                                                              'name'] + '\'')
