...
def logtimevaluedata(database, tablename, timeinseconds, value, logsize=5000, logfrequency=0):
    timestring=datalib.gettimestring(timeinseconds)
    if datalib.isvalidtimestring(timestring):
        ...
        try:
            ...
            pass
        if timeinseconds-datalib.timestringtoseconds(lastpolltimestring) > logfrequency:
