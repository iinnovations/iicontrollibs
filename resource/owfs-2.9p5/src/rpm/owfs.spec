...
%define php_extdir %(php-config --extension-dir 2>/dev/null || php5-config --extension-dir 2>/dev/null || php4-config --extension-dir 2>/dev/null || echo /usr/lib/php5/20100525+lfs)
#don't use the PHPLIBDIR here... assume php-config works instead.
