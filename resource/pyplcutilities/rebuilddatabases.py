...
filedir = ""
dirs.output = "/var/boatdata/controldata/"
...
if rebuild=='y':
    ...
    database = dirs.output + 'vmscontrol.db'
...
if rebuild=='y':
    ...
    database = dirs.output + 'datamap.db'
...
if rebuild=='y':
    ...
    sqlitemultquery(dirs.output + name + "control.db",querylist)
