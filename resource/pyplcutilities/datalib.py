...
proclogdir = '/var/log/vmslogger/'
controldir = dataroot + 'controldata/'
datalogdir = dataroot + 'logdata/'
...
datareaderlogfile = proclogdir + boatname + 'datareader.log'
...
controldatabase = controldir + boatname + 'control.db'
datamapdatabase = controldir + boatname + 'datamap.db'
datalogdatabase = datalogdir + boatname + 'datalog.db'
readstatusdatabase = datalogdir + boatname + 'readstatus.db'
...
def csvdatamaptodatabase(outputdirectory, csvdatamapfilename):
    ...
    datamapdbpath = outputdirectory + '/' + datamapdbname
...
def csvcontroltemplatefiletocontroldatabase(csvsystemfilename, csvdatamapfilename):
    ############################
    ##############deprecated
    ###########################
...
def csvdatatologdatabase(csvfile, databasefile):
